          ...
          >
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div className="flex flex-col justify-center">
                <p className="text-xs font-semibold text-slate-300 uppercase tracking-widest mb-3">Project Name</p>
                <p className="text-2xl font-bold text-white">{selectedProject.project_name || selectedProject.name}</p>
              </div>
              <div className="flex flex-col justify-center">
                <p className="text-xs font-semibold text-slate-300 uppercase tracking-widest mb-3">Status</p>
                <span className={`inline-block px-4 py-2 rounded-full text-sm font-semibold w-fit ${
              ...
              <div className="flex flex-col justify-center">
                <p className="text-xs font-semibold text-slate-300 uppercase tracking-widest mb-3">Priority</p>
                <span className={`inline-block px-4 py-2 rounded-full text-sm font-semibold w-fit ${
              ...
              <div className="flex flex-col justify-center">
                <p className="text-xs font-semibold text-slate-300 uppercase tracking-widest mb-3">Stories Count</p>
